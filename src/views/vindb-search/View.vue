...
<script>
import SidebarLeft from '@/components/vindb-search/SidebarLeft.vue'
import Table1 from '@/components/vindb-search/Table1.vue'
import Table2 from '@/components/vindb-search/Table2.vue'
