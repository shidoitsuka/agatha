<template>
  <Dialog :open="isOpen" @close="setIsOpen" class="fixed inset-0 z-20 flex items-center justify-center">
    ...
    <div class="z-10 w-11/12 px-8 py-6 space-y-5 overflow-y-scroll rounded shadow-lg md:w-6/12 bg-base-200" style="height: 600px">
      <DialogTitle class="flex flex-col items-center justify-center">
        <h1 class="text-xl">Configure an Alert</h1>
        <h3 class="text-agatha-200">Make certain documents flag as notifaction whe we log into the system.</h3>
